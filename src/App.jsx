  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", background: "#0f1117", minHeight: "100vh", color: "#e8e0d0", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#1a1f2e,#0f1117)", borderBottom: "1px solid #2a2f3e", padding: "0 24px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", minHeight: 60, paddingTop: 8, paddingBottom: 8, flexWrap: "wrap", gap: 8 }}>
      ...
      <div style={{ flex: 1, maxWidth: 960, margin: "0 auto", width: "100%", padding: "20px 24px 0", display: "flex", flexDirection: "column" }}>
        {/* CHAT */}
        {view === "chat" && (
